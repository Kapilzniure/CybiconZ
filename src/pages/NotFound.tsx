  ...
  return (
    <SiteShell>
      <section className="relative min-h-[70vh] flex items-center overflow-hidden">
        ...
        <div className="absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full pointer-events-none" style={{ background: "rgba(124,58,237,0.15)", filter: "blur(120px)" }} />
        <div className="container relative text-center">
          ...
          <Link to="/" className="inline-flex mt-8 bg-accent-gradient text-white font-bold text-sm px-6 py-3 rounded-xl shadow-glow-purple">← Back home</Link>
        </div>
      </section>
    </SiteShell>
  );
